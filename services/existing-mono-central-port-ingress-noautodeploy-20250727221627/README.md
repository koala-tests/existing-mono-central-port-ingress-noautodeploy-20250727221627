# existing-mono-central-port-ingress-noautodeploy-20250727221627
...
```
docker build -t existing-mono-central-port-ingress-noautodeploy-20250727221627:latest .
docker run -p:5030:8080 existing-mono-central-port-ingress-noautodeploy-20250727221627:latest
```
